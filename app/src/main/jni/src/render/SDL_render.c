...
SDL_UpdateTextureYUVPlanar(SDL_Texture *texture, const SDL_Rect *rect,
    ...
    if (SDL_SW_UpdateYUVTexturePlanar(texture->yuv, rect, Yplane, Ypitch, Uplane, Upitch, Vplane,
                                      Vpitch) < 0) {
        return -1;
    }
...
int SDL_UpdateYUVTexture(SDL_Texture *texture, const SDL_Rect *rect,
    ...
    if (texture->yuv) {
        return SDL_UpdateTextureYUVPlanar(texture, rect, Yplane, Ypitch, Uplane, Upitch, Vplane,
                                          Vpitch);
    } else {
        ...
        if (renderer->UpdateTextureYUV) {
            return renderer->UpdateTextureYUV(renderer, texture, rect, Yplane, Ypitch, Uplane,
