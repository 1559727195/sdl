...
SDL_PrivateShouldInitSubsystem(Uint32 subsystem) {
    int subsystem_index = SDL_MostSignificantBitIndex32(subsystem);
    //LOGE("subsystem_index:%d\n,SDL_SubsystemRefCount[subsystem_index]:%d\n",subsystem_index,SDL_SubsystemRefCount[subsystem_index]);
    SDL_assert(SDL_SubsystemRefCount[subsystem_index] < 255);
...
//        LOGE("SDL_INIT_VIDEO | SDL_INIT_JOYSTICK:%x\n", SDL_INIT_VIDEO | SDL_INIT_JOYSTICK);
//
//
//        LOGE("flags & (SDL_INIT_VIDEO | SDL_INIT_JOYSTICK):%x\n",
...
//             "SDL_INIT_VIDEO:%x\n,"
//             "SDL_INIT_JOYSTICK:%x\n,"
//             "SDL_INIT_EVENTS:%x\n ", flags, SDL_INIT_VIDEO, SDL_INIT_JOYSTICK, SDL_INIT_EVENTS);
    }
